...
if(isset($_POST['submit'])) {
    ...
    $roll = sanitize(trim($_POST['roll_no']));
...
if (isset($_FILES['postimg'])) {
   ...
   if ($password == $password2) {
      $sql = "INSERT INTO students( roll_no, password, username, email, dept, numOfBooks, moneyOwed, photo, phoneNumber, name)
 VALUES ('$roll', '$password', '$username', '$email', '$dept', '$books', '$money', '$filename', '$phone', '$name' ) ";
        ...
        <div class="alert alert-success alert-dismissable">
            ...
            <div class="container">
                <form class="form-horizontal" role="form" action="addstudent.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="Password" class="col-sm-2 control-label">Roll NO</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="roll_no" placeholder="roll Number" id="password" required>
                        </div>      
                    </div>
                    <div class="form-group">
