...
include "includes/header.php";
	...
	if(isset($_FILES['imgUp'])) {
		...
		$sql = "INSERT into membercard (memberId, rollNo, issueDate, expiryDate, picture)
		 values ('$id','$roll','$issue','$expiry', '$filename')";
		...
		<div class="jumbotron login col-lg-10 col-md-11 col-sm-12 col-xs-12">
			...
			<div class="container">
				<form class="form-horizontal" role="form" action="addstudentcard.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="Username" class="col-sm-2 control-label">Roll NO.</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="roll" placeholder="Enter Roll No" id="username" required>
						</div>		
					</div>
					<div class="form-group">
