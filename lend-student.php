...
if(isset($_POST['submit'])){
	...
	$sql = "INSERT INTO borrow(memberName, rollNo, bookName, borrowDate, returnDate, bookId) values('$name', '$number', '{$bdata['bookTitle']}', '$bdate', '$due', '$bid')";
        ...
        <div class="alert alert-success alert-dismissable">
			...
			<div class="container">
				<form class="form-horizontal" role="form" action="lend-student.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="Member Card ID" class="col-sm-2 control-label">Roll NO</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="roll" value="<?php echo $number; ?>">
						</div>		
					</div>
					<div class="form-group">
